...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->enum('levelUser' , ['SAdmin','Admin' , 'Counter', 'AS Counter', 'salesManager' , 'Accountants', 'Agency', 'Agency Counter'])->default('Counter')->nullable(); //agency تعریف شرکت agency_counter تعریف کانتر شرکت همکار
            $table->string('levelPermission')->default('1')->nullable(); // 1 Agency Counter - 2 AS Counter - 3 Writer - 4 Editor - 5 salesManager - 6 Accountants - 9 Admin - 10 SAdmin
