                ...
                <div class="col-xl-8 mb-5">
                    <section class="scroll-section" id="listPost">
                        ...
                        <div class="card mb-3 border-color-runy-primary">
                            ...
                            <div class="card-body">
                            <textarea class="form-control editor" id="editor3"
                                      name="technical_info">{!! $product->technical_info !!}</textarea>
                            </div>
                        </div>

                        @livewire('admin.product.create.info-product' , ['product' => $product ] )
                        @livewire('admin.product.create.productfeature.productfeature' , ['product' => $product ] )
