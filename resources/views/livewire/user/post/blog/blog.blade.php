<div class="container-fluid p-0"  >
    ...
    <div class="container">
        ...
        <div class="row py-5">
            ...
            <div class="col-md-3">
                <div class="card mb-5 sticky-top shadow-sm sidebar_card">
                    ...
                    <div class="card-footer text-left">
                        <a href="https://mortazavistore.ir/post-category/Driver-Download" class="btn btn-outline-primary">مشاهده همه</a>
                    </div>
                </div>
                <div class="card bg- mb-5 sticky-top shadow-sm sidebar_card recent_products">
                    <div class="card-header">
                    ...
                    @endforeach
                    <div class="card-footer text-left">
                        <a href="{{ asset('/shop') }}" class="btn btn-outline-primary">مشاهده همه</a>
                    </div>
                </div>
                <div class="card bg- mb-5 sticky-bottom shadow-sm sidebar_card">
                    <div class="card-header">
