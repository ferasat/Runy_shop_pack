<div class="">
    <div class="section-header">
        ...
        <h5 class="h2">محصولات پرطرفدار</h5>
        <div class="btn-box">
            <a href="{{ asset('/shop') }}">
                مشاهده همه
    ...
    <section class="job_section layout_padding py-5">
        <div class="container">
                            ...
                            <div class="product-grid bg-white">
                                <div class="product-image">
                                    ...
                                    <ul class="product-links">
                                        <li><a href="#" data-tip="افزودن به سبد خرید">
                                        ...
                                        <li><a href="#" data-tip="محصولات مشابه">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <li><a href="#" data-tip="قیمت بهتری دارید؟">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <div class="product-content">
                                    ...
                                    <div class="price"><span> 1,500,000 تومان</span> 850,000 تومان</div>
                                    <a class="add-to-cart" href="#">مشاهده</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
