<!-- category section -->
<section class="category_section py-5 overflow-hidden">
    <div class="container-fluid bg-danger">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4 col-xl-2 px-0">
                <a href="#" class="box">
                    <div class="img-box">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-cloud-plus" viewBox="0 0 16 16">
            ...
            <div class="col-sm-6 col-md-4 col-xl-2 px-0">
                <a href="#" class="box">
                    <div class="img-box">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-usb-drive" viewBox="0 0 16 16">
