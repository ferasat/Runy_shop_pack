<footer class="main-footer default">
    <div class="back-to-top">
        <a href="#">
            <span class="icon"><i class="now-ui-icons arrows-1_minimal-up"></i></span> <span>بازگشت به
                        بالا</span>
        </a>
    </div>
    <div class="container">
        ...
        <div class="info">
            <div class="row">
                ...
                <div class="col-12 col-lg-2">آدرس ایمیل:<a href="#">info@digikala.com</a>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="symbol col-12 col-lg-5">
                    <a href="#" target="_blank"><img src="{{ asset('theme/img/symbol-01.png') }}" alt=""></a>
                    <a href="#" target="_blank"><img src="{{ asset('theme/img/symbol-02.png') }}" alt=""></a>
                </div>
