                ...
                <div class="container">
                    <ul class="list float-right">
                            ...
                            <ul class="sub-menu nav">
                                ...
                                <li class="list-item list-item-has-children">
                                    ...
                                    <ul class="sub-menu nav">
                                        ...
                                        <li class="list-item">
                                            <i class="now-ui-icons arrows-1_minimal-left"></i><a class="main-list-item nav-link" href="#">ماشین حساب</a>
                                        </li>
                                        <li class="list-item">
                                            <i class="now-ui-icons arrows-1_minimal-left"></i><a class="main-list-item nav-link" href="#">دستگاه کپی</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="list-item list-item-has-children">
                                ...
                                <li class="list-item list-item-has-children">
                                    <i class="now-ui-icons arrows-1_minimal-left"></i><a class="nav-link" href="#">کالای استوک</a>
                                    <ul class="sub-menu nav">
                                        <li class="list-item">
                                ...
                                <li class="list-item list-item-has-children">
                                    <i class="now-ui-icons arrows-1_minimal-left"></i><a class="nav-link" href="#">سامانه تعمیرات
                                    </a>
                                    <ul class="sub-menu nav">
                                        <li class="list-item">
                        ...
                        <li class="list-item list-item-has-children mega-menu mega-menu-col-5">
                            ...
                            <ul class="sub-menu nav">
                                <li class="list-item list-item-has-children">
                                    <i class="now-ui-icons arrows-1_minimal-left"></i><a class="main-list-item nav-link" href="#">تعمیر تجهیزات فروشگاهی</a>
                                    <ul class="sub-menu nav">
                                        <li class="list-item">
                        ...
                        <li class="list-item list-item-has-children mega-menu mega-menu-col-5">
                            ...
                            <ul class="sub-menu nav">
                                <li class="list-item list-item-has-children">
                                    <i class="now-ui-icons arrows-1_minimal-left"></i><a class="main-list-item nav-link" >لوازم جانبی گوشی</a>
                                    <ul class="sub-menu nav">
                                        <li class="list-item">
                                        ...
                                        <li class="list-item list-item-has-children">
                                            <i class="now-ui-icons arrows-1_minimal-left"></i><a class="main-list-item nav-link" >گوشی موبایل
                                            </a>
                                            <ul class="sub-menu nav">
                                                <li class="list-item">
                                        ...
                                        <li class="list-item">
                                            <i class="now-ui-icons arrows-1_minimal-left"></i><a class="main-list-item nav-link" >ساعت هوشمند
                                            </a>
                                        </li>
                                        <li class="list-item">
                                            <i class="now-ui-icons arrows-1_minimal-left"></i><a class="main-list-item nav-link" >اسپیکر بلوتوث و با سیم</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="list-item list-item-has-children">
                                ...
                                <li class="list-item list-item-has-children">
                                    <i class="now-ui-icons arrows-1_minimal-left"></i><a class="nav-link" >تبلت و کتابخوان</a>
                                    <ul class="sub-menu nav">
                                        <li class="list-item">
                                ...
                                <li class="list-item list-item-has-children">
                                    <i class="now-ui-icons arrows-1_minimal-left"></i><a class="nav-link" >کامپیوتر و تجهیزات جانبی
                                    </a>
                                    <ul class="sub-menu nav">
                                        <li class="list-item">
                        ...
                        <li class="list-item">
                            <a class="nav-link" href="http://localhost:63342/mortazavi-bootstrap/articles.html?_ijt=ucfrq60mf07i33i51jis2ngb4d&_ij_reload=RELOAD_ON_SAVE">مقالات</a>
                        </li>
                        <li class="list-item">
                        ...
                        <li class="list-item amazing-item">
                            ...
                            <a class="nav-link" href="http://localhost:63342/mortazavi-bootstrap/signinpage.html?_ijt=ucfrq60mf07i33i51jis2ngb4d&_ij_reload=RELOAD_ON_SAVE">
