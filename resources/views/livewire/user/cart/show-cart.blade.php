        ...
        <div class="col-12 p-2">
            <table id="cart" class="table table-hover table-condensed ">
                ...
                <tr class="text-center">
                    <th style="width:50%">مورد</th>
                    <th style="width:10%">قیمت</th>
                    <th style="width:8%">تعداد</th>
                    <th style="width:22%" class="text-center">قیمت کل</th>
                        ...
                        <tr>
                            ...
                            <td data-th="Quantity">
                                <div class="flex items-center justify-center">
                                    <button class="btn btn-primary btn-sm" wire:click="decreaseQuantity('{{ $id }}')">
                                        -
                                    </button>
                                    <span class="mx-2">{{ $product['quantity'] }}</span>
                                    <button class="btn btn-primary btn-sm" wire:click="increaseQuantity('{{ $id }}')">
                                        +
                                    </button>
                                </div>
                            </td>
                            <td data-th="Subtotal"
                                class="text-center">{{ $product['price'] * $product['quantity'] }}</td>
                            <td class="actions" data-th="">
                                <button class="btn btn-danger btn-sm" wire:click="removeFromCart('{{ $id }}')">x
                                </button>
                            </td>
                        </tr>
                    @endforeach
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <button id="btn" class="btn btn-success" wire:click.prevent="apply({{$total}})">اعمال
                            </button>
                        </div>
