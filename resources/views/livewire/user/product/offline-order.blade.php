            ...
            <div class="card mb-5">
                <div class="card-body">
                    ...
                    <label class="mb-3 top-label">
                        <input class="form-control" name="name" wire:model.lazy="name" />
                        <span>نام</span>
                    </label>
                    <label class="mb-3 top-label">
                        <input class="form-control" name="name"  wire:model.lazy="family"/>
                        <span>نام خانوادگی</span>
                    </label>
                    <label class="mb-3 top-label">
                        <input class="form-control" type="number"   wire:model.lazy="cell" placeholder="912..."/>
                    ...
                    <label class="mb-3 top-label w-100">
                        <input class="form-control" type="number"  wire:model.lazy="capacity"/>
                        <span>تعداد</span>
                    </label>

                    <div class="mb-3 top-label">
                        <textarea id="note_customer" class="form-control" rows="2" wire:model.lazy="note_customer"></textarea>
