        ...
        <div class="card-body">
            <div class="row g-2">
                <div class="col-8">
                    ...
                    <input type="text" class="form-control" id="name" name="name" wire:model.live.blur="name">
                    @error('name') <span class="text-danger">{{ $message }}</span> @enderror
                </div>
                <div class="col">
                    <label for="slug">نام یکتا</label>
                    <input type="text" class="form-control" id="slug" name="slug" wire:model.live.blur="slug">
