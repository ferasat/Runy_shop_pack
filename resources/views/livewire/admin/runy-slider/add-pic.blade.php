    ...
    <div class="card-body">
        <div class="row g-2" >
            ...
            <div class="col-2">
                ...
                <input type="text" class="form-control" id="new_name_pic" name="new_name_pic" wire:model.live="new_name_pic">
            </div>
            <div class="col-md-3">
                <label for="new_text_pic">متن روی تصویر</label>
                <input type="text" class="form-control" id="new_text_pic" name="new_text_pic" wire:model.live="new_text_pic">
            </div>
            <div class="col-md-2">
                <label for="new_link_pic">لینک تصویر</label>
                <input type="text" class="form-control" id="new_link_pic" name="new_link_pic" wire:model.live="new_link_pic">
            </div>
            <div class="col-md-2">
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" name="new_file_pic" id="new_file_pic" wire:model.live="new_file_pic">
