<div class="row">
    <div class="col-md-8 mb-5">
        <section class="scroll-section" id="listPost">
            ...
            <div class="card mb-3 border-color-runy-primary">
                ...
                <div class="card-body mb-n2 border-last-none h-100">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control border-color-runy-primary" wire:model.blur="name">
                        @error('name')<span class="text-danger">عنوان نظرسنجی را لطفا وارد کنید</span>  @enderror
                    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-8">
                            ...
                            <input type="text" class="form-control border-color-runy-primary" wire:model.blur="question_title">
                            @error('question_title')<span class="text-danger">عنوان سوال را وارد کنید</span>  @enderror
                        </div>
                        <div class="col-2">
            ...
            @if(count($questionsTemp)>0)
                <div class="card mb-3">
                    <div class="card-header">سوالات</div>
                    <div class="card-body">
                        @foreach($questionsTemp as $questionTemp)
                            @livewire('admin.poll.temp.show-poll-questions-temp' , compact( 'questionTemp' ) , key($questionTemp->id.rand(1,999)))
                        @endforeach
