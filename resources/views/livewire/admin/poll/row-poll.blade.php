...
{{--                @endif--}}
                ...
                <a class="btn btn-outline-secondary btn-sm ms-1" wire:click.privent="cloneProduct({{$poll->id}})">رو
                    نوشت</a>
                <a class="btn btn-outline-danger btn-sm ms-1"
                   href="{{ asset('/dashboard/product/delete/'.$poll->id) }}" {{--wire:click.privent="deleteProduct({{$poll->id}})"--}}>حذف</a>
