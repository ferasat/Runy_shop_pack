    ...
    <div class="card">
        ...
        <div class="card-body row">
            <div class="col-md-4 py-2">
                ...
                <input type="text" class="form-control" id="site_name" wire:model.lazy="site_name">
            </div>
            <div class="col-md-4 py-2">
                <label for="site_short_description" class="form-label">شعار سایت</label>
                <input type="text" class="form-control" id="site_short_description" wire:model.lazy="site_short_description">
            </div>
            <div class="col-md-4 py-2">
                <label for="site_url" class="form-label">آدرس سایت</label>
                <input type="text" class="form-control text-lg-start " dir="ltr" id="site_url" wire:model.lazy="site_url">
            </div>
            <div class="col-md-4 py-2">
                <label for="site_url" class="form-label">آیا SSL دارید؟</label>
                <select class="form-control text-lg-start " dir="rtl" wire:model.lazy="have_ssl">
            ...
            <div class="col-md-4 py-2">
                ...
                <input type="text" class="form-control text-lg-start " dir="ltr" id="dash_url" wire:model.lazy="dash_url">
            </div>
            <div class="col-md-4 py-2">
                <label for="office_phone" class="form-label">تلفن دفتر</label>
                <input type="text" class="form-control" id="office_phone" wire:model.lazy="office_phone">
            </div>
            <div class="col-md-4 py-2">
                <label for="mobile_phone" class="form-label">شماره همراه</label>
                <input type="text" class="form-control" id="mobile_phone" wire:model.lazy="mobile_phone">
            </div>
        </div>
