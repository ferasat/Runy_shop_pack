    ...
    <div class="card">
        ...
        <div class="card-body row">
            ...
            <div class="col-md-4 py-2">
                ...
                <input type="text" class="form-control" id="site_short_description" wire:model.live.blur="site_short_description">
            </div>
            <div class="col-md-4 py-2">
                <label for="site_url" class="form-label">آدرس سایت</label>
                <input type="text" class="form-control text-lg-start " dir="ltr" id="site_url" wire:model.live.blur="site_url">
            </div>
            <div class="col-md-4 py-2">
            ...
            <div class="col-md-4 py-2">
                ...
                <input type="text" class="form-control text-lg-start " dir="ltr" id="dash_url" wire:model.live.blur="dash_url">
            </div>
            <div class="col-md-4 py-2">
