    ...
    <div class="card-body">
        <div>
            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="name_{{$user->id}}" wire:model.lazy="name"
                       placeholder="نام">
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="family_{{$user->id}}" wire:model.lazy="family"
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="cell_{{$user->id}}" wire:model.lazy="cell"
            ...
            <div class="form-floating mb-3">
                <input type="email" class="form-control" wire:model.lazy="email" id="email_{{$user->id}}"
                       placeholder="ایمیل">
            ...
            <div class="form-floating mb-3">
                <select class="form-control" wire:model.lazy="role" id="role">
            ...
            <div class="form-floating mb-3">
                <select class="form-control" wire:model.lazy="levelPermission" id="levelPermission_{{$user->id}}">
            ...
            <div class="form-floating mb-3">
                <textarea class="form-control" wire:model.lazy="address" id="address_{{$user->id}}" placeholder="آدرس"
                          rows="3"></textarea>
                <label for="address">آدرس</label>
            </div>

            <div class="form-floating mb-3">
                <input type="password" class="form-control" wire:model.lazy="password" id="password_{{$user->id}}"
                       placeholder="رمز">
