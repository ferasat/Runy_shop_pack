                            ...
                            <div class="card-body">
                                ...
                                @else
                                    <div class="d-flex justify-content-between">
                                        <span>نام : </span>
                                        <span><input class="form-control" wire:model="name" value="{{ $cart->name }}"/></span>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <span>شماره تماس : </span>
                                        <span><input class="form-control" wire:model="cell" value="{{ $cart->cell }}"/></span>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <span>کدپستی : </span>
                                        <span><input class="form-control" wire:model="zip_code" value="{{ $cart->zip_code }}"/></span>
                                    </div>
                                    <div class="d-block">
                                        <span class="d-block">آدرس : </span>
                                        <span class="d-block">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 {{ statusCartColor($status) }}">
                                    ...
                                    <select class="form-select" id="status{{$cart->id}}" wire:model.live="status">
                                        ...
                                        <option value="being_packaged">شروع بستبندی</option>
                                        <option value="ready_to_send">آماده ارسال</option>
                                        <option value="delivered">رسیده</option>
