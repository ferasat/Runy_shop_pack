        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="productSearch" wire:model.live.blur="wordSearch" wire:keydown.enter="search_products()" placeholder="حداقل سه کارکتر وارد کنید">
