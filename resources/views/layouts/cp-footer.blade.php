    ...
    <div class="container">
        ...
        <div class="info">
            <div class="row">
                ...
                <div class="col-12 col-lg-2">آدرس ایمیل:<a href=http://ehsanghasimi.ir/>info@digikala.com</a>
                </div>
                <div class="col-12 col-lg-4 text-center">
                    <a href=http://ehsanghasimi.ir/ target="_blank"><img src="assets/img/bazzar.png" width="159" height="48" alt=""></a>
                    <a href=http://ehsanghasimi.ir/ target="_blank"><img src="assets/img/sibapp.png" width="159" height="48" alt=""></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="site-description col-12 col-lg-7">
                    ...
                    <p>
                        دیجی کالا به عنوان یکی از قدیمی‌ترین فروشگاه های اینترنتی با بیش از یک دهه تجربه، با پایبندی به سه اصل کلیدی، پرداخت در محل، 7 روز ضمانت بازگشت کالا و تضمین اصل‌بودن کالا، موفق شده تا همگام با فروشگاه‌های معتبر جهان، به بزرگ‌ترین فروشگاه اینترنتی ایران
                        تبدیل شود. به محض ورود به دیجی کالا با یک سایت پر از کالا رو به رو می‌شوید! هر آنچه که نیاز دارید و به ذهن شما خطور می‌کند در اینجا پیدا خواهید کرد.
                    </p>
                </div>
                <div class="symbol col-12 col-lg-5">
                    <a href=http://ehsanghasimi.ir/ target="_blank"><img src="assets/img/symbol-01.png" alt=""></a>
                    <a href=http://ehsanghasimi.ir/ target="_blank"><img src="assets/img/symbol-02.png" alt=""></a>
                </div>
                <div class="col-12">
                    <div class="row">
