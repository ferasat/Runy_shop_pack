    ...
    <div class="container">
        <div class="navbar-translate">
            <a class="navbar-brand" href="#pablo">
                <img src="assets/img/logo.png" height="24px" alt="runy">
            </a>
            ...
            <div class="search-nav default">
                <form action="">
                    ...
                    <button type="submit"><img src="assets/img/search.png" alt="runy"></button>
                </form>
                <ul>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navigation">
            <div class="logo-nav-res default text-center">
                <a href="#">
                    <img src="assets/img/logo.png" height="36px" alt="runy">
                </a>
            </div>
